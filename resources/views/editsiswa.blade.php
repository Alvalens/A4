      ...
      <div class="orders">
        <div class="row justify-content-center">
          <div class="col-xl-8">
              ...
              <div class="card-body card-block">
                <div class="row form-group">
                  <div class="col col-md-3">
                    ...
                    <a href="{{ $siswa->name}}" class="form-control-static">{{ $siswa->name }}</a>
                  </div>
                </div>
                <div class="row form-group">
                  <div class="col col-md-3">
                  ...
                  <div class="col-12 col-md-9">
                    <a href="{{ $siswa->email }}" class="form-control-static">{{ $siswa->email }}</a>
                  </div>
                </div>
                <div class="row form-group">
                  <div class="col col-md-3">
            ...
            <a href="{{ route('datasiswa') }}" class="badge badge-light" style="float:right;" role="button">Kembali</a>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <input type="password" class="form-control" id="password" name="password"
                value="{{ old('password') ?? $siswa->password }}">
            </div>
          </div>
