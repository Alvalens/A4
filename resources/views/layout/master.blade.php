          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('bermain') }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#0e4168" class="bi bi-puzzle" viewBox="0 0 16 16" transform="rotate(90)">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('tekateki') }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#0e4168" class="bi bi-lightbulb" viewBox="0 0 16 16">
