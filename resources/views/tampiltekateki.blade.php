          ...
          <div class="col-xl-8">
            <div class="card">
              <div class="card-header">
                {{ $question->id }}
                <hr><strong>{{ $question->pertanyaan }}</strong>
              </div>
            ...
            <a href="{{ route('datatekateki') }}" class="badge badge-light" style="float:right;"
