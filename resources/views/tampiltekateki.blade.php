...
<div class="modal fade" id="fileModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="fileModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('tekatekis.update', ['question'=>$question->id]) }}" method="POST">
                @method('PATCH')
                @csrf
                <input type="hidden" value="{{ old('id') ?? $question->id }}">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="kunci" class="form-label"><strong>Kunci Jawaban</strong></label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="level" name="level" value="{{ old('level') ?? $question->level }}">
                    </div>
                </div>
